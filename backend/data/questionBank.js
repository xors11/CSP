// Auto-generated Massive Question Bank with 100% DIRECT NATURAL QUESTIONS
...
const finalQuestionBank = {
  "9th Mathematics": {
    "mcqs": [
      ...
      {
        "q": "Which formula calculates the area of a triangle given its three sides?",
        "options": [
          "Heron's Formula",
          "Pythagoras Theorem",
          "Euler's Formula",
      ...
      {
        "q": "What does the y-coordinate represent in Cartesian geometry?",
        "options": [
      ...
      {
        "q": "Which theorem states the square of the hypotenuse equals the sum of the squares of the other two sides?",
        "options": [
          "Pythagoras Theorem",
          "Mid-point Theorem",
          "Thales Theorem",
      ...
      {
        "q": "What is the surface area of a cube with side 'a'?",
        "options": [
          "6a²",
          "a³",
          "4a²",
      ...
      {
        "q": "What is the value of pi (π) approximately?",
        "options": [
          "3.14",
          "2.71",
          "1.41",
  ...
  "9th Science": {
    "mcqs": [
      ...
      {
        "q": "Which organelle is the powerhouse?",
        "options": [
          "Mitochondria",
          "Nucleus",
          "Ribosome",
      ...
      },
      {
        "q": "What is a mixture?",
        "options": [
          "Physical blend of two substances",
      ...
      {
        "q": "What is the process of solid to gas?",
        "options": [
          "Sublimation",
          "Evaporation",
          "Condensation",
      ...
      {
        "q": "What causes the Tyndall effect?",
        "options": [
  ...
  "9th Social Studies": {
    "mcqs": [
      {
        "q": "What is the primary causes of the French Revolution?",
        "options": [
          "Social inequality and economic crisis",
          "Invasion of neighboring countries",
          "Discovery of new trade routes",
          "Establishment of new scientific theories"
        ],
        "a": 0
      },
      {
        "q": "Which line of latitude passes through the middle of India?",
        "options": [
          "Tropic of Cancer",
          "Equator",
          "Tropic of Capricorn",
      ...
      {
        "q": "Which revolution introduced the concept of liberty, equality, and fraternity?",
        "options": [
          "French Revolution",
          "Russian Revolution",
      ...
      {
        "q": "What is the study of population statistics called?",
        "options": [
          "Demography",
          "Geography",
          "Sociology",
      ...
      {
        "q": "Which of the following is a non-farming activity in rural areas?",
        "options": [
          "Dairy farming",
          "Sowing seeds",
          "Harvesting crops",
      ...
      {
        "q": "What defines the standard meridian of India?",
        "options": [
          "82°30' E",
          "88°30' E",
          "97°25' E",
      ...
      {
        "q": "Which body guarantees the fundamental rights of Indian citizens?",
        "options": [
          "The Judiciary",
          "The Parliament",
          "The Cabinet",
      ...
      {
        "q": "What is the main resource used in modern farming under the Green Revolution?",
        "options": [
          "HYV seeds and chemical fertilizers",
          "Organic manure and wooden tools",
          "Traditional seeds and hand watering",
          "Rainwater harvesting alone"
        ],
        "a": 0
      },
      {
        "q": "What was the main reason for the Russian Revolution of 1917?",
        "options": [
          "Widespread poverty and Tsar's autocratic rule",
      ...
      {
        "q": "What does the term 'Sovereign' mean in the Preamble of the Indian Constitution?",
        "options": [
          "People have supreme right to make decisions",
          "Head of state is an elected person",
  ...
  "10th Mathematics": {
    "mcqs": [
      {
        "q": "What does Euclid's Division Lemma state?",
        "options": [
          "a = bq + r",
          "a² + b² = c²",
          "sin² + cos² = 1",
      ...
      {
        "q": "What is the discriminant of a quadratic equation ax² + bx + c = 0?",
        "options": [
          "b² - 4ac",
          "b² + 4ac",
          "4ac - b²",
      ...
      {
        "q": "What is the nth term of an Arithmetic Progression?",
        "options": [
          "a + (n-1)d",
          "a + nd",
          "a - (n-1)d",
      ...
      {
        "q": "If two triangles are similar, the ratio of their areas is equal to the ratio of the squares of their:",
        "options": [
          "Corresponding sides",
          "Perimeters",
          "Altitudes",
      ...
      {
        "q": "What are the roots of a quadratic equation if the discriminant is zero?",
        "options": [
          "Real and equal",
          "Real and distinct",
          "Imaginary",
      ...
      {
        "q": "What is the distance of a point (x, y) from the origin?",
        "options": [
          "√(x² + y²)",
          "x + y",
          "x² + y²",
      ...
      {
        "q": "Which trigonometric ratio corresponds to Opposite/Hypotenuse?",
        "options": [
          "Sine",
          "Cosine",
          "Tangent",
  ...
  "10th Science": {
    "mcqs": [
      {
        "q": "Which process do plants use to make food?",
        "options": [
          "Photosynthesis",
          "Respiration",
          "Transpiration",
      ...
      {
        "q": "What states that current is proportional to voltage?",
        "options": [
          "Ohm's Law",
          "Faraday's Law",
          "Newton's Law",
      ...
      {
        "q": "What is the bending of light called?",
        "options": [
          "Refraction",
          "Reflection",
          "Dispersion",
      ...
      {
        "q": "Which element shows catenation heavily?",
        "options": [
          "Carbon",
          "Oxygen",
          "Nitrogen",
      ...
      {
        "q": "What is the chemical formula for Plaster of Paris?",
        "options": [
          "CaSO4.1/2H2O",
          "CaSO4.2H2O",
          "Na2CO3",
  ...
  "10th English": {
    "mcqs": [
      ...
      {
        "q": "What does the dust of snow represent in Robert Frost's poem?",
        "options": [
          "A sudden change in mood and healing power of nature",
          "A terrible storm",
          "Cold winter weather",
      ...
      {
        "q": "According to Nelson Mandela, what is the greatest wealth of a nation?",
        "options": [
          "Its people",
      ...
      {
        "q": "What is the central theme of 'Fire and Ice'?",
        "options": [
          "Destruction of the world through desire and hatred",
          "The beauty of nature in winter",
          "The struggle between heat and cold",
          "The scientific explanation of global warming"
        ],
        "a": 0
      },
      {
        ...
        "options": [
          "His crops were ruined by a hailstorm and he needed money",
          "He wanted to thank God for the rain",
      ...
      {
        "q": "Who was the young seagull afraid to fly in 'His First Flight'?",
        "options": [
          "He lacked confidence and feared his wings wouldn't support him",
          "He was injured",
      ...
      {
        "q": "What did the postmaster do after reading Lencho's letter?",
        "options": [
          "He decided to help Lencho by collecting money",
          "He threw the letter in the dustbin",
          "He mocked Lencho's ignorance",
          "He sent the police to investigate"
        ],
        "a": 0
      },
      {
        "q": "What did Mandela learn about courage?",
        "options": [
          "It is the triumph over fear, not the absence of it",
          "It is having no fear at all",
          "It is the ability to fight without fear",
          "It is running away from danger safely"
        ],
        "a": 0
      },
      {
        "q": "What is the name of the dog in 'A Triumph of Surgery'?",
        "options": [
          "Tricki",
          "Joe",
          "Hector",
      ...
      {
        "q": "Why was Mrs. Pumphrey worried about Tricki?",
        "options": [
          "He was listless and overfed, showing no interest in food",
          "He ran away",
      ...
      {
        "q": "Who is the midnight visitor in Robert Arthur's story?",
        "options": [
      ...
      {
        "q": "What did Horace Danby like to collect?",
        "options": [
  ...
  "11th Physics": {
    "mcqs": [
      ...
      {
        "q": "What principle explains fluid lift (like an airplane wing)?",
        "options": [
      ...
      },
      {
        ...
        "options": [
          ...
          "Linear speed along a curve",
          "Rotational force"
        ],
        "a": 0
      },
      {
        "q": "What is escape velocity from Earth?",
        "options": [
          "11.2 km/s",
          "3x10^8 m/s",
          "9.8 m/s",
  ...
  "11th Chemistry": {
    "mcqs": [
      ...
      {
        "q": "What block do Alkali metals belong to?",
        "options": [
          "s-block",
          "p-block",
          "d-block",
      ...
      {
        "q": "What does Le Chatelier's principle govern?",
        "options": [
      ...
      {
        "q": "What is the formula for calculating pH?",
        "options": [
          "-log[H+]",
          "log[OH-]",
          "14 - pOH",
      ...
      {
        "q": "What is a hydrocarbon with double bonds called?",
        "options": [
          "Alkene",
          "Alkane",
          "Alkyne",
      ...
      {
        "q": "What states that volume is directly proportional to temperature?",
        "options": [
          "Charles's Law",
          "Boyle's Law",
          "Avogadro's Law",
  ...
  "11th Mathematics": {
    "mcqs": [
      ...
      {
        "q": "What is the formula for nCr (Combinations)?",
        "options": [
          "n! / (r!(n-r)!)",
          "n! / (n-r)!",
          "n! / r!",
      ...
      {
        "q": "What does 'i' represent in complex numbers?",
        "options": [
          "√-1",
          "√1",
          "1",
      ...
      {
        "q": "Which progression multiplies by a constant ratio?",
        "options": [
      ...
      {
        "q": "What does the Binomial Theorem expand?",
        "options": [
      ...
      {
        "q": "What is an empty set denoted by?",
        "options": [
          "Ø",
          "{0}",
          "U",
      ...
      {
        "q": "Which conic section has an eccentricity equal to 1?",
        "options": [
          "Parabola",
          "Ellipse",
          "Hyperbola",
  ...
  "12th Physics": {
    "mcqs": [
      ...
      {
        "q": "What phenomenon produces electricity from a changing magnetic field?",
        "options": [
      ...
      {
        "q": "Which device converts mechanical energy to AC electrical energy?",
        "options": [
          "AC Generator",
          "Transformer",
          "Motor",
      ...
      },
      {
        ...
        "options": [
          "Light reflecting entirely within a denser medium",
      ...
      {
        "q": "What proved the particle nature of light?",
        "options": [
          "Photoelectric Effect",
          "Young's Double Slit",
          "Diffraction",
      ...
      {
        "q": "What logic gate outputs 1 only if all inputs are 1?",
        "options": [
          "AND gate",
          "OR gate",
          "NOT gate",
      ...
      },
      {
        ...
        "options": [
          ...
          "Total lifetime of an atom",
          "Time for a nucleus to split",
          "Time to reach absolute zero"
        ],
        "a": 0
      }
    ],
    ...
    "mcqs": [
      {
        ...
        "options": [
          "A symmetrical 3D arrangement of atoms",
          "A random arrangement of gas molecules",
          "A liquid solution",
          "A polymer chain"
        ],
        "a": 0
      ...
      {
        "q": "What equation relates cell potential to concentration?",
        "options": [
          "Nernst Equation",
          "Arrhenius Equation",
          "Ideal Gas Equation",
      ...
      },
      {
        ...
        "options": [
          "Rate depends linearly on one reactant",
      ...
      },
      {
        ...
        "options": [
          "Accumulation of substance on a surface",
          "Penetration of substance into the bulk",
          "Mixing of two liquids",
          "Evaporation of a gas"
        ],
        "a": 0
      },
      {
      ...
      },
      {
        "q": "What is a ligand?",
        "options": [
          "An ion/molecule attached to a central metal",
          "A pure metal atom",
      ...
      },
      {
        "q": "What are polymers?",
        "options": [
          "Large molecules of repeating structural units",
      ...
      {
        "q": "What is the process of converting an ore into its oxide called?",
        "options": [
      ...
      {
        "q": "What acts as a biological catalyst?",
        "options": [
          "Enzymes",
          "Vitamins",
          "Carbohydrates",
  ...
  "12th Biology": {
    "mcqs": [
      ...
      {
        "q": "What is the process of DNA copying itself?",
        "options": [
          "Replication",
          "Transcription",
          "Translation",
      ...
      {
        "q": "What theory did Charles Darwin propose?",
        "options": [
          "Natural Selection",
      ...
      {
        "q": "What vectors transmit Malaria?",
        "options": [
      ...
      {
        "q": "What is PCR used for in biotechnology?",
        "options": [
      ...
      {
        "q": "What is the main function of the placenta?",
        "options": [
      ...
      {
        "q": "What does ecological succession mean?",
        "options": [
          "Gradual process of change in species structure",
          "Sudden extinction of a species",
          "Migration of birds",
  ...
  "B.Tech Data Structures": {
    "mcqs": [
      ...
      {
        "q": "What is the time complexity of searching in a Binary Search Tree (average)?",
        "options": [
          "O(log n)",
          "O(n)",
          "O(1)",
      ...
      },
      {
        ...
        "options": [
          "Elements pointing to the next node",
      ...
      },
      {
        ...
        "options": [
          "Fast data retrieval via key mapping",
          "Sorting elements",
          "Balancing a tree",
      ...
      },
      {
        "q": "What is a Graph?",
        "options": [
          "A non-linear structure of nodes and edges",
          "A strictly linear array",
          "A simple integer",
          "A sorting function"
        ],
        "a": 0
      ...
      {
        "q": "What does Time Complexity describe?",
        "options": [
          "Computational time taken by an algorithm",
          "Physical area of code",
          "Memory space used",
      ...
      {
        "q": "Which algorithm sorts by repeatedly swapping adjacent elements?",
        "options": [
          "Bubble Sort",
          "Merge Sort",
          "Quick Sort",
  ...
  "B.Tech React.js": {
    "mcqs": [
      ...
      },
      {
        ...
        "options": [
          "A lightweight JS copy of the DOM",
          "A browser extension",
      ...
      {
        "q": "Which hook manages state in a functional component?",
        "options": [
          "useState",
          "useEffect",
          "useRef",
      ...
      },
      {
        ...
        "options": [
          "A function returning a component",
          "A class component",
          "A global variable",
          "A DOM element"
        ],
      ...
      {
        "q": "Which hook memoizes a computationally expensive value?",
        "options": [
          "useMemo",
          "useCallback",
          "useRef",
      ...
      },
      {
        ...
        "options": [
          "To uniquely identify elements for rendering",
          "To encrypt data",
          "To style items",
          "To sort arrays"
        ],
      ...
      {
        "q": "What hook returns a mutable ref object?",
        "options": [
          "useRef",
          "useState",
          "useEffect",
      ...
      {
        "q": "What is Redux commonly used for?",
        "options": [
      ...
      {
        "q": "How do you conditionally render a component?",
        "options": [
          "Using ternary operators or logical &&",
          "Using CSS display:none only",
  ...
  "B.Tech Python": {
    "mcqs": [
      ...
      {
        "q": "What data structure does a dictionary use?",
        "options": [
          "Key-Value pairs",
          "Indexed array",
          "Linked List",
      ...
      {
        "q": "What does the GIL do in Python?",
        "options": [
      ...
      },
      {
        ...
        "options": [
          "Methods with double underscores (e.g., __init__)",
          "Deprecated methods",
          "Methods imported from C",
          "Syntax errors"
        ],
        "a": 0
      },
  ...
  "B.Tech Machine Learning": {
    "mcqs": [
      ...
      },
      {
        ...
        "options": [
          "Model learns the training data too well, failing to generalize",
      ...
      {
        "q": "What does Cross-Validation do?",
        "options": [
          "Evaluates model performance on different subsets of data",
          "Increases the dataset size infinitely",
          "Deletes outliers",
      ...
      },
      {
        ...
        "options": [
          "A configuration set before the learning process begins",
      ...
      },
      {
        "q": "What is an Epoch?",
        "options": [
          "One full pass of the training dataset through the algorithm",
      ...
      {
        "q": "What does a Convolutional Neural Network (CNN) excel at?",
        "options": [
          "Image recognition",
  ...
  "B.Tech Web Development": {
    "mcqs": [
      ...
      {
        "q": "Which property in CSS changes the background color?",
        "options": [
          "background-color",
          "color",
          "bgcolor",
      ...
      {
        "q": "What does a REST API use for communication?",
        "options": [
          "HTTP requests",
      ...
      {
        "q": "What is the purpose of JWT?",
        "options": [
          "Securely transmitting information as a JSON object",
          "Styling web pages",
          "Querying a database",
      ...
      },
      {
        ...
        "options": [
          ...
          "Centralized Output Routing Server",
      ...
      },
      {
        ...
        "options": [
          ...
          "let is a constant, var is mutable",
          "There is no difference",
          "var is only for numbers"
        ],
        "a": 0
      },
      {
      ...
      {
        "q": "What does CSS Flexbox do?",
        "options": [
          "Provides a more efficient way to lay out, align and distribute space",
    ...
    "mcqs": [
      {
        ...
        "options": [
          "The core of the OS that manages resources",
          "The user interface",
          "A web browser",
          "A device driver"
        ],
      ...
      {
        "q": "What does Virtual Memory do?",
        "options": [
          "Simulates additional RAM using disk space",
      ...
      },
      {
        ...
        "options": [
          "Saving the state of a process to load another",
          "Switching monitors",
      ...
      },
      {
        "q": "What is Paging?",
        "options": [
          "Memory management scheme to eliminate contiguous allocation",
      ...
      },
      {
        "q": "What is Thrashing?",
        "options": [
          "System spending more time paging than executing",
          "Fast execution of code",
          "A virus infecting files",
          "Encrypting data rapidly"
        ],
        "a": 0
      },
      {
        "q": "What does a Scheduler do?",
        "options": [
      ...
      },
      {
        ...
        "options": [
          "A signal to the CPU indicating an event needs attention",
          "A power failure",
          "A user closing an app",
      ...
      },
      {
        ...
        "options": [
          ...
          "A process with maximum priority"
        ],
        "a": 0
      },
      {
    ...
    "mcqs": [
      ...
      },
      {
        ...
        "options": [
          ...
          "Always Consistent Independent Data",
      ...
      },
      {
        ...
        "options": [
          "A field that identifies a row of another table",
          "A primary key",
          "A candidate key",
          "A super key"
        ],
      ...
      {
        "q": "Which command is a DDL command?",
        "options": [
          "CREATE",
          "SELECT",
          "INSERT",
      ...
      {
        "q": "What does a Transaction represent?",
        "options": [
      ...
      },
      {
        ...
        "options": [
          "A stored procedure that automatically runs on an event",
          "A command to delete the database",
  ...
  "B.Tech Computer Networks": {
    "mcqs": [
      ...
      {
        "q": "What protocol operates at the Transport Layer?",
        "options": [
          "TCP",
          "IP",
          "HTTP",
      ...
      {
        "q": "What does HTTPS use for security?",
        "options": [
          "SSL/TLS",
          "FTP",
          "ICMP",
      ...
      },
      {
        ...
        "options": [
          "A security system monitoring incoming/outgoing traffic",
          "A physical cable",
          "A routing algorithm",
          "A web browser"
        ],
      ...
      {
        "q": "What protocol is used for sending emails?",
        "options": [
          "SMTP",
          "FTP",
          "HTTP",
    ...
    "mcqs": [
      {
        ...
        "options": [
          "Iterative development emphasizing flexibility",
      ...
      },
      {
        ...
        "options": [
          "Typical solutions to common software problems",
      ...
      {
        "q": "What does Unit Testing do?",
        "options": [
          "Tests individual components of software",
      ...
      },
      {
        ...
        "options": [
          "Frequently merging working copies to a shared mainline",
      ...
      },
      {
        ...
        "options": [
          "Structuring an app as loosely coupled services",
      ...
      },
      {
        ...
        "options": [
          "A linear, sequential approach to development",
          "An iterative loop process",
          "A flexible prototyping methodology",
          "An automated deployment script"
        ],
        "a": 0
      },
      {
        "q": "What does Scrum focus on?",
        "options": [
          "Managing iterative development via sprints",
          "A database indexing strategy",
          "A hardware configuration protocol",
          "A testing framework"
        ],
        "a": 0
      },
    ...
    "mcqs": [
      {
        ...
        "options": [
          "Study of individual/firm decisions",
          "Study of national economy",
          "Study of global trade",
          "Study of historical currencies"
        ],
        "a": 0
      },
      {
      ...
      {
        "q": "Who usually controls Monetary Policy?",
        "options": [
          "The Central Bank",
          "The President",
          "The Congress",
      ...
      {
        "q": "What characterizes a Monopoly?",
        "options": [
      ...
      },
      {
        ...
        "options": [
          ...
          "A ban on exports",
          "A domestic income tax"
        ],
        "a": 0
      },
      {
        "q": "What is the main goal of a purely capitalist economy?",
        "options": [
          "Profit maximization and free markets",
  ...
  "B.Tech Java": {
    "mcqs": [
      ...
      {
        "q": "Which collection stores unique values?",
        "options": [
          "Set",
          "List",
          "ArrayList",
      ...
      {
        "q": "Java supports which type of inheritance?",
        "options": [
          "Single inheritance",
          "Multiple inheritance using classes",
          "Circular inheritance",
          "Hybrid inheritance directly"
        ],
        "a": 0
      },
      {
        "q": "Which access modifier is most secure?",
        "options": [
          "private",
          "public",
          "protected",
      ...
      {
        "q": "Which keyword is used for interface implementation?",
        "options": [
          "implements",
          "inherit",
          "extends",
      ...
      {
        "q": "Which thread method starts execution?",
        "options": [
          "start()",
          "execute()",
          "init()",
      ...
      {
        "q": "Which statement is used to stop loop?",
        "options": [
          "break",
          "stop",
          "terminate",
...
module.exports = { getQuestionsForSubjects, finalQuestionBank };
